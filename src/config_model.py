...
BASE_PATH = 'data'
VIDEOS_PATH = os.path.sep.join(BASE_PATH, 'videos')
METADATA_PATH = os.path.sep.join(BASE_PATH, 'WLASL_v0.3.json')

# define the path to the base output directory
BASE_OUTPUT = "output"

# Define the path to the output serialized model
MODEL_PATH = os.path.sep.join([BASE_OUTPUT, "sign_detector.h5"])
