...
class Leaderboard:
    ...
    def update_leaderboard(self, history, test_results, model_name, model_type):
        ...
        if (True in self.lb['model_type'].isin(model_type)) and (True in self.lb['model_name'].isin(model_name)):
